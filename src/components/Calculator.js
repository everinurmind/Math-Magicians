  ...
  return (
    <div className="container">
      ...
      <div className="calculator">
        <Display value={calculatorState.operation ? `${calculatorState.total} ${calculatorState.operation} ${calculatorState.next || ''}` : calculatorState.next || calculatorState.total || '0'} />
        <div className="keypad">
          ...
          <div className="row">
            ...
            <button type="button" className="key" onClick={() => handleClick('.')}>.</button>
            <button type="button" className="key operator2" onClick={() => handleClick('=')}>=</button>
          </div>
        </div>
      </div>
    </div>
